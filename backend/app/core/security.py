...
CSRF_EXEMPT_PATHS = {"/api/auth/csrf", "/api/auth/token", "/api/auth/password-reset/request", "/api/auth/password-reset/confirm", "/api/storefront/quote", "/api/payments/webhook", "/webhooks/meta/whatsapp"}
